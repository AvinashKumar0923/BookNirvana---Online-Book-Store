  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='space-y-6 md:w-1/2'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Welcome to the ultimate online destination for book enthusiasts! Whether searching for a gripping novel, an enlightening non-fiction, or a charming children's book, the perfect read awaits. The vast collection spans every genre and caters to all ages, ensuring that the next great read is just a click away. Dive into the curated selections and uncover hidden gems or timeless classics. Happy reading!</p>
